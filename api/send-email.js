...
export default async function handler(req, res) {
  ...
  // Base URL del sitio (para los botones Aprobar/Rechazar)
  const BASE_URL = `https://${req.headers.host}`;
  // ¿Este tipo requiere aprobación de gerentes?
...
<div style="max-width:600px;margin:0 auto;padding:20px 0">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#fff;border-bottom:4px solid #C0392B;border-radius:10px 10px 0 0"><tr>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#C0392B"><tr>
    ...
    <td style="padding:16px 24px 16px 0;vertical-align:middle">
      <div style="font-size:15px;font-weight:700;color:#fff;line-height:1.4">${subject.replace(' | ', '<br>Cliente: ')}</div>
    </td>
  </tr></table>
